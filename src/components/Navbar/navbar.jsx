    ...
    <Navbar expand="lg" className="bg-body-tertiary">
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav
            className="mx-auto my-lg-2 my-lg-0 gap-lg-3 gap-sm-1 d-flex flex-wrap justify-content-center"
            style={{ maxHeight: '100px', overflowX: 'auto' }}  // Added horizontal scroll on small screens
            navbarScroll
          >
            {/* Home Link */}
